...
const MA_TOKEN = "0x89b70f36168429604cE3c084552e9cF453A91d06";
const RELEASE_CONTRACT = "0x22d7E4b936c504d124767a8B4fB9C8F3724438Ef";
...
async function getMAPrice(): Promise<number> {
  try {
    const res = await fetch(BSC_RPC, {
      ...
      body: JSON.stringify({ jsonrpc: "2.0", method: "eth_call", id: 1, params: [{ to: "0x3F994e6AF97D3153C22AbFDcE55361e932bD0DAA", data: "0xa035b1fe" }, "latest"] }),
    });
